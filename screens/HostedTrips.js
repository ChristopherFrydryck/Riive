                            ...
                            :
                                ...
                                <View style={{paddingVertical: 16, flexDirection: 'column'}}>
                                    <View style={{flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 4}}>
                                        ...
                                        <Text type="Medium" numberOfLines={1} style={isCancelled && visit.cancelledBy === 'host' ? {fontSize: 24, color: Colors.hal500, flex: 0}: {fontSize: 24, flex: 0}}>{isCancelled ? visit.cancelledBy === 'host' ? visit.hostCharged : ((visit.refundAmtCents + (visit.price.riiveCreditTotalCents || 0))/100).toLocaleString("en-US", {style:"currency", currency:"USD"}) : visit.price.price}</Text>
